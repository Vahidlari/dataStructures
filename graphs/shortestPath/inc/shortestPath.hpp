...
private:
    ...
    /// unvisited vertices. The list get updated when a vertix is visited, in which, the distances to 
    /// its destination vertices are updated if they could be reached in a shorter patch compared to
